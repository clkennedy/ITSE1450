...
public class Projectiles {
    ...
    /*private static Animation<TextureRegion> getFireBallAnim(){
        Animation<TextureRegion> anim = Avatars.load(FireBall, 8, 8, .05f, true);
        return anim;
    }
    
    private static Animation<TextureRegion> getIceNovaAnim(){
        Animation<TextureRegion> anim = Avatars.loadWithTrim(IceNova, 10, 10, .05f, true, 14);
        return anim;
    }
    
    private static Animation<TextureRegion> getSlashAnim(){
        Animation<TextureRegion> anim = Avatars.load(Slash);
        return anim;
    }
    private static Animation<TextureRegion> getShatterAnim(){
