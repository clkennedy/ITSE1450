...
public class HeroSelectionScreen extends BaseScreen {
    ...
    public static Hero currentSelection = Hero.heros[0];
    ...
    public void initialize() {
        ...
        for(Hero bActor : Hero.heros){
            BaseActor b = new BaseActor();
            b.setAnimation(bActor.playRight());
            b.setSize(100, 100);
        ...
        for(Hero bActor : Hero.heros){
            BaseActor b = new BaseActor();
            Label name = new Label(bActor.getName(), names);
