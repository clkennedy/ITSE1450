 ...
 */
package com.dslayer.content.selections;
...
public class Selections {
    ...
    public static String Green = "Selections/selectionGreen.png";
    public static String Red = "Selections/selectionRed.png";
    ...
    public static Animation<TextureRegion> Red(){
        return Avatars.load(Red);
    }
    public static Animation<TextureRegion> Purple(){
        return Avatars.load(Purple);
    }
